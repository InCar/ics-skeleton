package com.incarcloud.skeleton.log;
    ...
    public synchronized static Logger getLogger(LogConfig logConfig){
        ...
        if(logConfig.isEnableLog()) {
            ...
            if(logConfig.isEnableConsoleLog()){
                ConsoleHandler consoleHandler = getConsoleHandler(simpleFormatter);
                consoleHandler.setLevel(logConfig.getLevel());
                logger.addHandler(consoleHandler);
            }
            if(logConfig.isEnableFileLog()) {
                FileHandler fileHandler = getFileHandler(simpleFormatter, logConfig.getFileLogDir());
                fileHandler.setLevel(logConfig.getLevel());
